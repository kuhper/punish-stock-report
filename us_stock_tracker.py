...
POSITION_OVERRIDE = {
    ...
    "RCL": "郵輪第二大",
    "STZ": "啤酒/烈酒品牌",
    "TAP": "啤酒品牌(Miller/Coors)",
    "TGT": "折扣百貨連鎖",
    "WYNN": "高端賭場度假村",
    "YUM": "速食品牌集團(肯德基)",
    "BF-B": "威士忌品牌(Jack Daniels)",
    # 能源/原物料
    "DVN": "美國頁岩油氣",
    "EOG": "美國頁岩油氣",
    "HAL": "油田服務巨頭",
...
SECTOR_CN = {
    ...
    "Consumer Cyclical": "消費循環", "Consumer Defensive": "消費防禦",
...
def get_position(sym, industries):
    """取得個股定位：手動覆蓋 > Yahoo產業翻譯 > sector翻譯 > 原文"""
